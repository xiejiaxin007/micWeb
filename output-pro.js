当前环境为： production https://log.julive.com/_.gif
{
  mode: 'production',
        ...
        use: [
          /* config.module.rule('js').use('cache-loader') */
          {
            ...
            options: {
              ...
              cacheIdentifier: '71457013'
            }
          },
          /* config.module.rule('js').use('thread-loader') */
          {
            loader: '/Users/administrator/Documents/Learn/new-add/micWeb/webapp_backend/node_modules/thread-loader/dist/cjs.js'
          },
  ...
  plugins: [
    ...
    new DefinePlugin(
      {
        'process.env': {
          VUE_APP_REPORT_URL: '"https://log.julive.com/_.gif"',
          VUE_APP_ID: '"ySJBesz1609739144374"',
          NODE_ENV: '"production"',
